...
function BoardsMenuItemsDataLoader({
  ...
  children: (data: {
    boards: (Board & { collaboratorsCount: number })[] | null;
  }) => React.ReactNode;
        ...
        <>
          ...
          <DropdownMenu.Group>
            ...
            {personalBoards.map((board) => {
              ...
              return (
                <Link key={board.id} reloadDocument to={`/boards/${board.id}`}>
          ...
          <DropdownMenu.Content>
            ...
            <BoardsMenuItemsDataLoader fallback={<BoardsMenuItemsSkeleton />}>
              {({ boards: currentUserBoards }) => {
                if (!currentUserBoards) {
                  return <BoardsMenuItemsSkeleton />;
                }

                return (
                  <BoardsMenuItems currentUserBoards={currentUserBoards} />
                );
              }}
